...
l1 = [1, 2, 1, 1, 1, 1, 2, 3, 1, 2, 1, 1, 1, 1, 1, 1, 1, 2, 3, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 2, 3, 2, 2, 2, 2, 2, 2, 2, 1, 2, 1, 1]
...
print(f"second 3 :{l1.index(3, l1.index(3, l1.index(3) + 1) + 1)}")
...
l4 = l3.copy()              # Deep copy - copies the values
